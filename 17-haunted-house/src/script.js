...
// Fog
const fog = new THREE.Fog('#262837', 1, 25); // color, near, far
scene.fog = fog
...
const walls = new THREE.Mesh(
    new THREE.BoxGeometry(4, 2.5, 4, 10, 10, 10), // width, height, depth, widthSegments, heightSegments, depthSegments
...
roof.rotation.y = Math.PI / 4; // rotate an eighth of a circle
house.add(roof)
...
// door.geometry.setAttribute('uv2', new THREE.Float32BufferAttribute(door.geometry.attributes.uv.array, 2)) // can ignore with three.js v0.151 and up
...
doorLight.position.set(0, door.geometry.parameters.height + 0.2, walls.geometry.parameters.depth / 2 + 0.7)
house.add(doorLight)
